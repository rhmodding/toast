...
void App::Update() {
...

    {
        ...
        ImGui::SliderFloat("Current key angle", &this->animatable->getCurrentKey()->angle, 0.f, 360.f);
        ImGui::SliderFloat("Current key scale X", &this->animatable->getCurrentKey()->scaleX, 0.f, 10.f);
